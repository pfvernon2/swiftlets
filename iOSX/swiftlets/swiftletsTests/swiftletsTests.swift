...
class swiftletsTests: XCTestCase {
    ...
    func testMagnitude() {
        ...
        XCTAssertEqual(yoctoTest1.1, DecimalMagnitude.yocto)
        ...
        XCTAssertEqual(yoctoTest2.1, DecimalMagnitude.yocto)
        ...
        XCTAssertEqual(yoctoTest3.1, DecimalMagnitude.yocto)
        ...
        XCTAssertEqual(hectoTest2.1, DecimalMagnitude.hecto)
        ...
        XCTAssertEqual(megaTest1.1, DecimalMagnitude.mega)
        ...
        XCTAssertEqual(megaTest2.1, DecimalMagnitude.mega)
        ...
        XCTAssertEqual(yotaTest.1, DecimalMagnitude.yota)
        ...
        XCTAssertEqual(kibiTest.1, BinaryMagnitude.kibi)
        ...
        XCTAssertEqual(gibiTest.1, BinaryMagnitude.gibi)
        ...
        XCTAssertEqual(yobiTest.1, BinaryMagnitude.yobi)
